...
# 3. Montagem Isolada do Escudo Real com Brilho Neon Pulsante via HTML Puro
escudo_html = """
<div style="background-color: #000000; display: flex; justify-content: center; align-items: center; height: 95vh; overflow: hidden;">
    ...
    <svg class="gremio-svg-neon" viewBox="0 0 491 507" xmlns="http://www.w3.org/2000/svg">
        ...
        <path id="caminho-texto" d="M 60,252 Q 245,197 430,252" fill="none" />
        <text font-family="'Arial Black', Impact, sans-serif" font-size="44" font-weight="900" fill="#000000" text-anchor="middle">
...
# 4. Injeta o componente isolado garantindo renderização total e sem vazamento de texto
st.components.v1.html(escudo_html, height=800)
