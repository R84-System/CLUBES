...
# 2. Configura o fundo da página principal do Streamlit para Black Total
st.markdown("""
    <style>
...
# 3. Envelopando o SEU SVG dentro de uma caixa HTML com efeito de luz pulsante
escudo_blindado = """
<div style="background-color: #000000; display: flex; justify-content: center; align-items: center; height: 95vh; overflow: hidden;">
    ...
    <svg class="gremio-neon-final" viewBox="0 0 491 507" xmlns="http://www.w3.org/2000/svg">
...
# 4. Injeta a caixa de forma isolada na nuvem
st.components.v1.html(escudo_blindado, height=800)
